# This Makefile is for the HTTP::Tiny extension to perl.
#
...
#     ABSTRACT => q[A small, simple, correct HTTP/1.1 client]
#     AUTHOR => [q[Christian Hansen <chansen@cpan.org>, David Golden <dagolden@cpan.org>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => { ExtUtils::MakeMaker=>q[6.17] }
#     DISTNAME => q[HTTP-Tiny]
#     EXE_FILES => []
#     LICENSE => q[perl]
#     MIN_PERL_VERSION => q[5.006]
#     NAME => q[HTTP::Tiny]
#     PREREQ_PM => { Carp=>q[0], Data::Dumper=>q[0], Exporter=>q[0], ExtUtils::MakeMaker=>q[0], Fcntl=>q[0], File::Basename=>q[0], File::Spec=>q[0], File::Temp=>q[0], IO::Dir=>q[0], IO::File=>q[0], IO::Socket=>q[0], IO::Socket::INET=>q[0], IPC::Cmd=>q[0], MIME::Base64=>q[0], Test::More=>q[0.96], Time::Local=>q[0], bytes=>q[0], open=>q[0], strict=>q[0], warnings=>q[0] }
#     TEST_REQUIRES => { Data::Dumper=>q[0], Exporter=>q[0], ExtUtils::MakeMaker=>q[0], File::Basename=>q[0], File::Spec=>q[0], File::Temp=>q[0], IO::Dir=>q[0], IO::File=>q[0], IO::Socket::INET=>q[0], IPC::Cmd=>q[0], Test::More=>q[0.96], open=>q[0] }
#     VERSION => q[0.054]
#     test => { TESTS=>q[t/*.t] }
...
PERL_ARCHLIBDEP = /usr/lib/perl5/5.14/x86_64-cygwin-threads
LIBPERL_A = libperl.a
...
PERL_INCDEP = /usr/lib/perl5/5.14/x86_64-cygwin-threads/CORE
...
TO_INST_PM = lib/HTTP/Tiny.pm

PM_TO_BLIB = lib/HTTP/Tiny.pm \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''A small, simple, correct HTTP/1.1 client'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Christian Hansen <chansen@cpan.org>, David Golden <dagolden@cpan.org>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  open: '\''0'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'configure_requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  ExtUtils::MakeMaker: '\''6.17'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'dynamic_config: 1' >> META_new.yml
	$(NOECHO) $(ECHO) 'generated_by: '\''ExtUtils::MakeMaker version 7.04, CPAN::Meta::Converter version 2.141520'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'license: perl' >> META_new.yml
	$(NOECHO) $(ECHO) 'meta-spec:' >> META_new.yml
	$(NOECHO) $(ECHO) '  url: http://module-build.sourceforge.net/META-spec-v1.4.html' >> META_new.yml
	$(NOECHO) $(ECHO) '  version: '\''1.4'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'name: HTTP-Tiny' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'version: '\''0.054'\''' >> META_new.yml
	-$(NOECHO) $(MV) META_new.yml $(DISTVNAME)/META.yml
	$(NOECHO) $(ECHO) Generating META.json
	$(NOECHO) $(ECHO) '{' > META_new.json
	$(NOECHO) $(ECHO) '   "abstract" : "A small, simple, correct HTTP/1.1 client",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Christian Hansen <chansen@cpan.org>, David Golden <dagolden@cpan.org>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	$(NOECHO) $(ECHO) '   "dynamic_config" : 1,' >> META_new.json
	$(NOECHO) $(ECHO) '   "generated_by" : "ExtUtils::MakeMaker version 7.04, CPAN::Meta::Converter version 2.141520",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "HTTP-Tiny",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "open" : "0"' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      },' >> META_new.json
	$(NOECHO) $(ECHO) '      "configure" : {' >> META_new.json
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "ExtUtils::MakeMaker" : "6.17"' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      },' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   "version" : "0.054"' >> META_new.json
	$(NOECHO) $(ECHO) '}' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>A small, simple, correct HTTP/1.1 client</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Christian Hansen &lt;chansen@cpan.org&gt;, David Golden &lt;dagolden@cpan.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="bytes::" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/HTTP/Tiny.pm blib/lib/HTTP/Tiny.pm 
